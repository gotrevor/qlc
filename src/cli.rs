...
struct CliArgs {
    ...
    /// Sets an import prefix for the root directory, ie `@/` to get `import {..} from "@/global-graphql-types"`
    #[arg(long, value_name = "PREFIX")]
    root_dir_import_prefix: Option<String>,
    /// Sets the file name used for global enums and objects, defaults to `global-graphql-types`
    ...
    pub fn from_cli() -> Self {
        ...
        RuntimeConfig {
            ...
            global_types_module_name: cli_args
                ...
                .unwrap_or_else(|| String::from("graphql-global-types")),
